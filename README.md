...
1.  **Model Pre-train tests** 
    * To ensure data quality through writing assertions on the different features of three datasets for example, 
        ...
        * The values of the PClass column must be 1, 2, or 3, otherwise, it is unknown value   
...
# Classification Algorithms
  ...
  * We have chosen classification algorithms that are equally present and have the same mathematical formulation with the same or similar set of             hyperparameters.
1.  LinearSVC
